...
class LocalizationService {
  static Map<String, Map<String, String>> get _translations => {
    'en': {
      ...
      'upload_health_documents': 'Upload Health Documents',
      'upload_health_documents_subtitle':
          'Upload your health history form and other medical documents',
      'health_form': 'Health History Form',
      'vaccination_card': 'Vaccination Card',
      'medical_diagnosis': 'Medical Diagnosis',
      'other_medical': 'Other Medical Document',
      'health_form_required': 'Health History Form is required',
    ...
    'el': {
      ...
      'health_documents': 'Έγγραφα Υγείας',
      'upload_health_documents': 'Ανέβασμα Εγγράφων Υγείας',
      'upload_health_documents_subtitle':
          'Ανεβάστε το ατομικό δελτίο υγείας και άλλα ιατρικά έγγραφα',
      'health_form': 'Ατομικό Δελτίο Υγείας',
      'vaccination_card': 'Κάρτα Εμβολιασμών',
      'medical_diagnosis': 'Ιατρική Γνωμάτευση',
      'other_medical': 'Άλλο Ιατρικό Έγγραφο',
      'health_form_required': 'Το Ατομικό Δελτίο Υγείας είναι υποχρεωτικό',
